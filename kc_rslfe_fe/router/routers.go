...
var routes = Routes{
	...
	Route{
		...
		strings.ToUpper("Post"),
		"/vibe_be/devices/transfer_ownership/{imei}/{partner_id}",
		VibeBeDevicesTransferOwnershipImeiPartnerIdPost,
	},
	...
	Route{
		...
		strings.ToUpper("Post"),
		"/vibe_be/devices/transfer_state/{imei}/{partner_id}",
		VibeBeDevicesTransferStateImeiPartnerIdPost,
	},
